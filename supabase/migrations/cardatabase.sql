...
INSERT INTO car_models (brand_id, name) VALUES
  ...
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'A-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'B-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'C-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'CLA-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'CLS-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'E-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'GLA-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'GLB-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'GLC-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'GLE-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'GLS-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'S-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'SL-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'SLC-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'Maybach S-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'EQB'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'EQC'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'EQE'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'EQS'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'G-Class'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG GT'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG C43'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG E63'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG G63'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG A45'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG CLA45'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG GLC63'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG S63'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG GT 4-Door'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG SL 63'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG GLE53'),
  ((SELECT id FROM car_brands WHERE name = 'Mercedes-Benz'), 'AMG GLA45'),
  ...
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A5'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A6'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A7'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A8'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q2'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q3'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q4 e-tron'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q5'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q7'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q8'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'R8'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S3'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S4'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S5'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S6'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S7'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S8'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS3'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS4'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS5'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS6'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS7'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS Q3'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS Q5'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS Q8'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'e-tron'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'e-tron GT'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'e-tron S'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'e-tron S Sportback'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'Q5 e-tron'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'S Q5'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A4 Avant'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A6 Avant'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'A7 Sportback'),
  ((SELECT id FROM car_brands WHERE name = 'Audi'), 'RS Q8'),



  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '718 Cayman'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '718 Boxster'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 Carrera'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 Turbo'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 GT3'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 GT2 RS'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 Targa'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Cayenne'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Cayenne Coupe'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Macan'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Macan GTS'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Panamera'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Panamera Sport Turismo'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Taycan'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Taycan Cross Turismo'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Taycan Turbo'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Taycan Turbo S'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Taycan 4S'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Taycan 4S Cross Turismo'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 Speedster'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 R'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), '911 Turbo S'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Cayenne E-Hybrid'),
  ((SELECT id FROM car_brands WHERE name = 'Porsche'), 'Macan Turbo'),



  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Arteon'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Beetle'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Golf'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Golf GTI'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Golf R'),
  ...
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Tiguan R'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Touareg'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'ID.3'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'ID.4'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'ID. Buzz'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'ID.5'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Sharan'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Touran'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Arteon R'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Golf Alltrack'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Golf Variant'),
  ((SELECT id FROM car_brands WHERE name = 'Volkswagen'), 'Passat Alltrack')
